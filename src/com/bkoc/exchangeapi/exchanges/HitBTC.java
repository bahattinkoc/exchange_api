...
public class HitBTC extends General { // https://api.hitbtc.com/api/3/public
    public static List<String> getSymbols() throws IOException {
        ...
        */
        ...
        JsonObject symbolsListJsonObj = JsonParser
                .parseString(response("https://api.hitbtc.com/api/3/public/symbol"))
                .getAsJsonObject();
    ...
    public static HashMap<String, BigDecimal> ticker24hr(String symbol) throws IOException {
        ...
        */
        ...
        JsonObject klinesJson = JsonParser
                .parseString(response("https://api.hitbtc.com/api/3/public/ticker?symbols=" + symbol))
